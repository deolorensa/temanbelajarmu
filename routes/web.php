...
Route::middleware(['auth:sanctum', 'verified'])->group(function (){
    Route::get('/class', [PelajaranController::class, 'index'])->name('class');
...
Route::group(['middleware' => 'isAdmin'], function(){
    ...
    Route::get('upload/{id}', [PdfController::class, 'upload'])->name('upload');
    Route::put('upload/{id}', [PdfController::class, 'update'])->name('upload.pdf');
});
